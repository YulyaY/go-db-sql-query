...
func main() {
	...
	newClient := Client{
		FIO:      "Григорьев Александр Андреевич", // укажите ФИО
		Login:    "grigalex",                      // укажите логин
		Birthday: "19891107",                      // укажите день рождения
		Email:    "grigalex1989@gmail.com",        // укажите почту
	}
	...
	newLogin := "grigoriev" // укажите новый логин
